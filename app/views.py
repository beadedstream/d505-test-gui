...
class TestUtility(QMainWindow):
    ...
    def start_procedure(self):
        ...
        self.coin_cell_v_status = QLabel(f"Coin Cell Voltage: _____ V")
        ...
        self.coin_cell_v_status.setStyleSheet(status_lbl_stylesheet)
        ...
        status_vbox1.addWidget(self.coin_cell_v_status)
